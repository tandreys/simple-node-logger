...
const Logger = function(options) {
     ...
     * @param msg - 
     * @param {object} [extra=null] - additional values to log
     * 
     * @return entry
     */
    this.log = function(level, msg, extra) {
        const entry = logger.createEntry( level, msg , extra);
     ...
     * @return entry
     */
    this.openGroup = function(msg, extra){
        const entry = logger.createEntry( 'info', msg, extra );
        group.push(entry);
     ...
     * Close current group
     */
    this.beginTest = function(msg){
        group = [];
        this.log("begintest", msg);
    },

    /**
     * Close all groups
     */
    this.endTest = function(msg){
        group = [];
        this.log("endtest", msg);
    },
     ...
     */
    this.createEntry = function(level, messageList, extra) {
        const entry = {};
...
Logger.STANDARD_LEVELS = [ 'all', 'trace', 'debug', 'info', 'warn', 'error', 'fatal', 'begintest', 'endtest' ];
